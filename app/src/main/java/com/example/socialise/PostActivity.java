...
public class PostActivity<StorageTask> extends AppCompatActivity {
    private Uri imageUri;
    private String imageUrl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(PostActivity.this);
                finish();
            }
        });
    ...
    if(imageUri!=null){
        ...
        StorageTask upload= filePath.putFile(imageUri);
        upload.continue(new Continuation() {
            @Override
            public Object then(@NonNull Task task) throws Exception {
                if (!task.isSuccessful()){
                    throw task.getException();
    ...
    private void startActivity(PostActivity postActivity) {
